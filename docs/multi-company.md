...
```
  ...
  1  LLC    BeauTech Power Systems    f99bd320-b400-...  ◄ default
  2  Corp   BeauTech Corp             a1b2c3d4-e5f6-...
```
...
```bash
bcli company alias LLC f99bd320-b400-4189-b3c1-c62c05d4e7a5 --name "BeauTech Power Systems LLC"
bcli company alias Corp a1b2c3d4-e5f6-7890-abcd-ef1234567890 --name "BeauTech Corp"
```
...
```
  ...
  LLC       BeauTech Power Systems     Customer A       ...
  LLC       BeauTech Power Systems     Customer B       ...
  Corp      BeauTech Corp              Customer X       ...
```
...
name = "BeauTech Power Systems LLC"
