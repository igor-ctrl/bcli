...
def _sample_entities() -> list[EntityDef]:
    return [
        EntityDef("engineOverviews", api_publisher="beautech", api_group="standard", api_version="v1.0"),
        EntityDef("leaseHeaders", api_publisher="beautech", api_group="standard", api_version="v1.0"),
    ]
...
class TestMakeResource:
    def test_resource_has_correct_name(self):
        entity = EntityDef("engineOverviews", api_publisher="beautech", api_group="standard", api_version="v1.0")
...
class TestAsyncExtract:
    ...
    async def test_custom_api_sets_route(self):
        ...
        query = client.query.return_value
        query.route.assert_called_once_with("beautech", "standard", "v1.0")
